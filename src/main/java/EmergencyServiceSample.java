...
public class EmergencyServiceSample extends javax.swing.JFrame {
    ...
    protected void setEmergencyService(EmergencyService aEmergencyService) {
        _emergencyService = aEmergencyService;
    }

    protected EmergencyService getEmergencyService() {
    ...
    protected void showState(EmergencyService aEmergencyService) {
        _currentState.setText(aEmergencyService.getContext().getState().getName());
    }

    protected void updateOptions(EmergencyService aEmergencyService) {
        Transition[] lTransitions = (Transition[]) _stateMap.get(aEmergencyService.getContext().getState());
    ...
    protected void processTransition() {
        ...
        if (lTransition != null) {
            try {
                lTransition.proceed(getEmergencyService(), lTransition.getArguments());
                ...
                showState(getEmergencyService());
                updateOptions(getEmergencyService());
            }
        }
    }
    ...
    public void reset() {
        clearLog();
        setEmergencyService(new EmergencyService());
        showState(getEmergencyService());
        updateOptions(getEmergencyService());
        _emergencyService.getContext().setDebugFlag(true);
        _emergencyService.getContext().setDebugStream(new java.io.PrintStream(new java.io.OutputStream() {
    ...
    protected abstract class Transition extends javax.swing.JComponent {
        ...
        public abstract void proceed(EmergencyService aEmergencyService, String[] aArguments);
    }
}